 ...
 */
@Controller
@RequestMapping("/base/schoolCard")
public class SchoolCardController extends BaseController {
    ...
    @RequiresPermissions("base:schoolCard:view")
    @RequestMapping()
    public String view() {
        return "base/schoolCard.html";
    }

    /**
     * 分页查询校园卡表
     */
    @RequiresPermissions("base:schoolCard:list")
    ...
    public PageResult<SchoolCard> page(HttpServletRequest request) {
        ...
        return new PageResult<>(schoolCardService.page(pageParam, pageParam.getWrapper()).getRecords(), pageParam.getTotal());
     ...
     * 添加校园卡表
     */
    @RequiresPermissions("base:schoolCard:save")
     ...
     * 修改校园卡表
     */
    @RequiresPermissions("base:schoolCard:update")
     ...
     * 删除校园卡表
     */
    @RequiresPermissions("base:schoolCard:remove")
